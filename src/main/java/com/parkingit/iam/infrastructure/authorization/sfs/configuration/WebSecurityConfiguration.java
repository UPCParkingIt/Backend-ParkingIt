package com.parkingit.iam.infrastructure.authorization.sfs.configuration;

import com.parkingit.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.parkingit.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.parkingit.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                "/api/v1/authentication/**","/api/v1/users/**", "/api/v1/devices/**","/api/v1/recognitions/**","/api/v1/vehicles/**","/api/v1/reservations/**","/api/v1/notifications/**","/v3/api-docs/**", "/swagger-ui.html",
